...
public class FrozenUpItems {
    ...
    public static final RegistryObject<Item> MUG_OF_CHOCOLATE_MILK = REGISTER.register("mug_of_chocolate_milk", () -> new ChocolateMilkMugItem(new Item.Properties().group(FrozenUp.GROUP).maxStackSize(1)));
    public static final RegistryObject<Item> MUG_OF_TRUFFLE_HOT_CHOCOLATE = REGISTER.register("mug_of_truffle_hot_chocolate", () -> new HotChocolateMugItem(new Item.Properties().group(FrozenUp.GROUP).maxStackSize(1)));
