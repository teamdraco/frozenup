...
public class ChocolateMilkMugItem extends BlockItem {
   public ChocolateMilkMugItem(Item.Properties builder) {
      super(FrozenUpBlocks.MUG_OF_CHOCOLATE_MILK.get(), builder);
   }
