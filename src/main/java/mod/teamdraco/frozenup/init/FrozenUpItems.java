...
public class FrozenUpItems {
    ...
    public static final RegistryObject<Item> EMPTY_MUG = REGISTER.register("empty_mug", () -> new Item(new Item.Properties().group(FrozenUp.GROUP)));
    public static final RegistryObject<Item> CUP_OF_MILK = REGISTER.register("cup_of_milk", () -> new MilkMugItem(new Item.Properties().group(FrozenUp.GROUP).maxStackSize(1)));
    public static final RegistryObject<Item> CHOCOLATE_MILK = REGISTER.register("chocolate_milk", () -> new ChocolateMilkItem(new Item.Properties().group(FrozenUp.GROUP).maxStackSize(1)));
    public static final RegistryObject<Item> HOT_CHOCOLATE = REGISTER.register("hot_chocolate", () -> new HotChocolateItem(new Item.Properties().group(FrozenUp.GROUP).maxStackSize(1)));
    ...
    public static final RegistryObject<BlockItem> FROZEN_FLOWER = REGISTER.register("frozen_flower", () -> new BlockItem(FrozenUpBlocks.FROZEN_FLOWER.get(), new Item.Properties().group(FrozenUp.GROUP)));
}
